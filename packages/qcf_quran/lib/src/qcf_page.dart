...
class QcfPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final baseFontSize = (fontSize ?? theme.fontSize ?? getFontSize(pageNumber, context)) * sp;
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final double boxWidth = constraints.maxWidth.isFinite ? constraints.maxWidth : screenSize.width;
        final double boxHeight = constraints.maxHeight.isFinite ? constraints.maxHeight : screenSize.height;
